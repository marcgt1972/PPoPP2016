...
operations like matrix-x-vector or matrix-x-matrix products and are often referred to as Level 2/3 BLAS operations \cite{BLAS}. 
...
computer vision. The MNIST dataset is composed of 60,000 images, each of dimension 28x28 pixels 
...
The CIFAR-10 is a CNN (Convolution Neural network) included in the Caffe distribution
that performs as an image classifier for the CIFAR dataset. CIFAR is 
composed of 60,000 32x32 color images with 10 classes: 
